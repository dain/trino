        ...
        extends DefaultJdbcMetadata
{
    ...
    @Inject
    public PhoenixMetadata(PhoenixClient phoenixClient, IdentifierMapping identifierMapping, Collection<TableFunction> tableFunctions)
    {
        super(phoenixClient, false, tableFunctions);
