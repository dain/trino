...
public class OAuth2Service
{
    ...
    @Inject
    public OAuth2Service(OAuth2Config oauth2Config, @ForOAuth2 HttpClient httpClient)
    {
        ...
        this.jwtParser = Jwts.parser()
                .setSigningKeyResolver(new JWKSSigningKeyResolver(URI.create(oauth2Config.getJwksUrl()), httpClient));
