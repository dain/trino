...
public class InterpretedFunctionInvoker
{
    ...
    {
        ScalarImplementation implementation = functionManager.getScalarImplementation(function, getInvocationConvention(function.getSignature(), function.getFunctionNullability()));
