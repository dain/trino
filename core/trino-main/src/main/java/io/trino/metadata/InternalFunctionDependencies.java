...
{
    private final BiFunction<ResolvedFunction, InvocationConvention, ScalarImplementation> specialization;
    ...
    public InternalFunctionDependencies(
            BiFunction<ResolvedFunction, InvocationConvention, ScalarImplementation> specialization,
    ...
    @Override
    public ScalarImplementation getScalarImplementation(QualifiedFunctionName name, List<Type> parameterTypes, InvocationConvention invocationConvention)
    {
        FunctionKey functionKey = new FunctionKey(name, toTypeSignatures(parameterTypes));
        ResolvedFunction resolvedFunction = functions.get(functionKey);
        if (resolvedFunction == null) {
    ...
    @Override
    public ScalarImplementation getScalarImplementationSignature(QualifiedFunctionName name, List<TypeSignature> parameterTypes, InvocationConvention invocationConvention)
    {
    ...
    @Override
    public ScalarImplementation getOperatorImplementation(OperatorType operatorType, List<Type> parameterTypes, InvocationConvention invocationConvention)
    {
        OperatorKey operatorKey = new OperatorKey(operatorType, toTypeSignatures(parameterTypes));
        ResolvedFunction resolvedFunction = operators.get(operatorKey);
        if (resolvedFunction == null) {
    ...
    @Override
    public ScalarImplementation getOperatorImplementationSignature(OperatorType operatorType, List<TypeSignature> parameterTypes, InvocationConvention invocationConvention)
    {
    ...
    @Override
    public ScalarImplementation getCastImplementation(Type fromType, Type toType, InvocationConvention invocationConvention)
    {
        CastKey castKey = new CastKey(fromType.getTypeSignature(), toType.getTypeSignature());
        ResolvedFunction resolvedFunction = casts.get(castKey);
        if (resolvedFunction == null) {
    ...
    @Override
    public ScalarImplementation getCastImplementationSignature(TypeSignature fromType, TypeSignature toType, InvocationConvention invocationConvention)
    {
