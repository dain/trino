        ...
        implements ImplementationDependency
{
    ...
    protected abstract ScalarImplementation getImplementation(FunctionBinding functionBinding, FunctionDependencies functionDependencies, InvocationConvention invocationConvention);
