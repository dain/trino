        ...
        extends ScalarImplementationDependency
{
    ...
    @Override
    protected ScalarImplementation getImplementation(FunctionBinding functionBinding, FunctionDependencies functionDependencies, InvocationConvention invocationConvention)
    {
        List<TypeSignature> types = applyBoundVariables(argumentTypes, functionBinding);
        return functionDependencies.getScalarImplementationSignature(fullyQualifiedFunctionName, types, invocationConvention);
    }
