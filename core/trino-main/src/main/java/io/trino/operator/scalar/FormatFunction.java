        ...
        extends SqlScalarFunction
{
    ...
    private static BiFunction<ConnectorSession, Block, Object> valueConverter(FunctionDependencies functionDependencies, Type type, int position)
    {
        ...
        if (type.equals(JSON)) {
            MethodHandle handle = functionDependencies.getScalarImplementation(QualifiedFunctionName.of("json_format"), ImmutableList.of(JSON), simpleConvention(FAIL_ON_NULL, NEVER_NULL)).getMethodHandle();
