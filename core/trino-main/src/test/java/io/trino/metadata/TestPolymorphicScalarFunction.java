...
public class TestPolymorphicScalarFunction
{
            ...
            throws Throwable
    {
        ...
        ChoicesSpecializedSqlScalarFunction specializedFunction = (ChoicesSpecializedSqlScalarFunction) function.specialize(
                ...
                new InternalFunctionDependencies(FUNCTION_MANAGER::getScalarImplementation, ImmutableMap.of(), ImmutableSet.of()));
    ...
    public void testSetsHiddenToTrueForOperators()
    {
        ...
        BoundSignature boundSignature = new BoundSignature(signature.getName(), createVarcharType(INPUT_VARCHAR_LENGTH), ImmutableList.of(createVarcharType(INPUT_VARCHAR_LENGTH)));
        function.specialize(boundSignature, new InternalFunctionDependencies(FUNCTION_MANAGER::getScalarImplementation, ImmutableMap.of(), ImmutableSet.of()));
    }
    ...
    public void testFailIfTwoMethodsWithSameArguments()
    {
        ...
        assertThatThrownBy(() -> function.specialize(BOUND_SIGNATURE, new InternalFunctionDependencies(FUNCTION_MANAGER::getScalarImplementation, ImmutableMap.of(), ImmutableSet.of())))
                .isInstanceOf(IllegalStateException.class)
